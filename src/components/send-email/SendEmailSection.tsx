...
export const SendEmailSection = () => {
  return (
    ...
    />
    <h2 className="text-4xl font-bold self-center pb-6 text-slate-800 drop-shadow-sm">Envianos un correo</h2>

   <div className="flex flex-col items-center movil:w-[80%] tablet:w-2/3 self-center">
        <label className="self-start font-semibold w-auto  movil:min-w-20 tablet:min-w-48" htmlFor="name">Organizacion:</label>
