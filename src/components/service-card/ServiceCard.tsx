...
export const ServiceCard = ({ title, description, imgUrl}:Props) => {
    return ( 
        <div className="overflow-hidden flex flex-col items-center border border-gray-200 rounded-lg tablet:flex-row md:max-w-xl hover:bg-gray-100  shadow-lg cursor-pointer md:hover:scale-[1.15] transition-all tablet:max-h-64 tablet:min-h-52">
